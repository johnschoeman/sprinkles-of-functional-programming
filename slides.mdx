...
<Horizontal>
<div style={{ width: "500px"}}><h4>OO -> Behavior</h4></div>
...
<div>
<div>If you are modeling <text style={{ color: Colors.primary }}>behavior</text>,</div>
...
<div>perfer <text style={{ color: Colors.primary }}>data pipelines</text> and <text
...
<div>is perhaps a better distinction.</div>
...
<ul>
<Appear>
<li style={{width: "150%"}}>Resource modeling</li>
<li style={{width: "150%"}}>Behaviour modeling</li>
<li style={{width: "150%"}}>State modeling</li>
</Appear>
</ul>
...
You can have both types of paradigms present in the same code base.
...
<li styles={{ width: "150%" }}>lots of collaborator mocking</li>
<li styles={{ width: "150%" }}>having to open many files to understand one task</li>
<li styles={{ width: "180%", border: "1px solid red" }}>lots of 'something-er' classes</li>
<li styles={{ width: "150%" }}>UML is a linked list</li>
</Appear>
</ul>
</Split>
...
<div><img style={{ width: "50%" }} src="./images/03.png" /></div>
